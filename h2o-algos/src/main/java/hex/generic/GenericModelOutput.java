            ...
            case Multinomial:
                ...
                if (mojoMetrics instanceof MojoModelMetricsMultinomialGLM) {
                    ...
                    return new ModelMetricsMultinomialGLMGeneric(null, null, mojoMetrics._nobs, mojoMetrics._MSE,
                            ...
                            glmMultinomial._r2, convertTable(glmMultinomial._multinomial_auc), convertTable(glmMultinomial._multinomial_aucpr), glmMultinomial._description);
                } else {
                    ...
                    return new ModelMetricsMultinomialGeneric(null, null, mojoMetrics._nobs, mojoMetrics._MSE,
                            ...
                            multinomial._mean_per_class_error, multinomial._r2, convertTable(multinomial._multinomial_auc), convertTable(multinomial._multinomial_aucpr), multinomial._description);
                }
            case Regression:
